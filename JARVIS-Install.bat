...
echo $line1 = 'Set WS = CreateObject("WScript.Shell")'>>"%PS%"
echo $line2 = 'WS.CurrentDirectory = "' + $INSTALL_DIR + '"'>>"%PS%"
echo $line3 = 'WS.Run "cmd /c npm start", 0, False'>>"%PS%"
echo $line4 = 'Set WS = Nothing'>>"%PS%"
echo ($line1, $line2, $line3, $line4) -join [System.Environment]::NewLine ^| Set-Content -Path $vbs -Encoding UTF8>>"%PS%"
echo.>>"%PS%"
